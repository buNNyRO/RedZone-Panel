...
$(document).ready(function() {
   var sparklineLogin = function() { 
        ...
        function mr() { return Math.floor((Math.random() * 10) + 1); }

        $('#sparklinedash').sparkline([ 0, mr(),mr(),mr(),mr(),mr(),mr(),mr()], {
            type: 'bar',
            height: '30',
            barWidth: '4',
            resize: true,
         ...
         $('#sparklinedash2').sparkline([ 0, mr(),mr(),mr(),mr(),mr(),mr(),mr()], {
            type: 'bar',
            height: '30',
            barWidth: '4',
            resize: true,
          ...
          $('#sparklinedash3').sparkline([ 0, mr(),mr(),mr(),mr(),mr(),mr(),mr()], {
            type: 'bar',
            height: '30',
            barWidth: '4',
            resize: true,
           ...
           $('#sparklinedash4').sparkline([ 0, mr(),mr(),mr(),mr(),mr(),mr(),mr()], {
            type: 'bar',
            height: '30',
            barWidth: '4',
            resize: true,
